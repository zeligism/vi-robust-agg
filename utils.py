    ...
    if args.gan:
        ...
        def init_optimizer(local_model):
            return {
                ...
                "D": torch.optim.Adam(local_model.D.parameters(), lr=client_lr * 2, betas=(0.0, 0.0)),
                "G": torch.optim.Adam(local_model.G.parameters(), lr=client_lr, betas=(0.0, 0.0)),
                "all": torch.optim.Adam(local_model.parameters(), lr=client_lr, betas=(0.0, 0.0)),
            }
